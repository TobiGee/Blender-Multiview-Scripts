...
def main(context):
    ...
    '''
    #########################################START########################################
    stl_filepath  = "\\\\alwncp01\stl"
    databasePath  = "C:\\Users\\GCHT\\Documents\\DatabaseV2"
    allViewAnkles = [[0,0,0],[0,0,90],[0,0,180],[0,0,270],[0,90,0],[0,-90,0]]
    ...
    for root, dirs, files in os.walk(stl_filepath, topdown=False):
        ...
        for name in files:
            ...
            if(name.endswith('.stl')):
                ...
                for ankles in allViewAnkles:
                    #End of amterialset
                    name = os.path.join(databasePath, name)[0:-4]+ str(ankles[0])+str(ankles[1])+str(ankles[2]) + '.png'
                    print('Rendering '+ name)
                    b.rotation_mode = 'XYZ'
                    b.rotation_euler[0] = ankles[0]
                    b.rotation_euler[1] = ankles[1]
                    b.rotation_euler[2] = ankles[2]
